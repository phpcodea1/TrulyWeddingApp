//
//  VenueRequestDetailsViewController.swift
...
class VenueRequestDetailsViewController: UIViewController {
    ...
    override func viewDidLoad()
    {
        ...
        if let mobile_no = mainDict.value(forKey: "mobile_no") as? String
        {
